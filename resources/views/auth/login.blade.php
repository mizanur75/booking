					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0">Sign in to continue to LawFirm.</p>							
							</div>
							<div class="p-40">
								<form action="{{ route('login') }}" method="post">
									...
									<div class="form-group">
										<div class="input-group mb-3">
                                            ...
                                            <input id="username" type="text" placeholder="username" class="form-control  ps-15 bg-transparent @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
